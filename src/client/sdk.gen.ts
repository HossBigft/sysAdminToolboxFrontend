...
/**
 * Get Ns Records Google
 */
export const getNsRecordsGoogle = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetNsRecordsGoogleData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetNsRecordsGoogleResponse, GetNsRecordsGoogleError, ThrowOnError>({
        ...options,
        url: '/api/v1/dns/resolve/google/ns/'
    });
};
