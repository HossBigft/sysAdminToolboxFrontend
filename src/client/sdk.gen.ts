 ...
 * Get Token
 */
export const getToken = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetTokenData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetTokenResponse, GetTokenError, ThrowOnError>({
        ...options,
        url: '/api/v1/plesk/token'
    });
};
