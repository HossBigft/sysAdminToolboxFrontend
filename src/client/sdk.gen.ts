 ...
 * Test access token
 */
export const testToken = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
 ...
 * Get A Record
 */
export const getARecord = <ThrowOnError extends boolean = false>(options: Options<GetArecordData, ThrowOnError>) => {
 ...
 * Get Ptr Record
 */
export const getPtrRecord = <ThrowOnError extends boolean = false>(options: Options<GetPtrRecordData, ThrowOnError>) => {
 ...
 */
export const getZoneMasterFromDnsServers = <ThrowOnError extends boolean = false>(options: Options<GetZoneMasterFromDnsServersData, ThrowOnError>) => {
 ...
 * Get Mx Record
 */
export const getMxRecord = <ThrowOnError extends boolean = false>(options: Options<GetMxRecordData, ThrowOnError>) => {
 ...
 * Get Ns Records
 */
export const getNsRecords = <ThrowOnError extends boolean = false>(options: Options<GetNsRecordsData, ThrowOnError>) => {
 ...
 * Retrieve users.
 */
export const readUsers = <ThrowOnError extends boolean = false>(options?: Options<ReadUsersData, ThrowOnError>) => {
 ...
 * Get current user.
 */
export const readUserMe = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
 ...
 * Delete own user.
 */
export const deleteUserMe = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
 ...
 * Update own password.
 */
export const updatePasswordMe = <ThrowOnError extends boolean = false>(options: Options<UpdatePasswordMeData, ThrowOnError>) => {
 ...
 */
export const readUserById = <ThrowOnError extends boolean = false>(options: Options<ReadUserByIdData, ThrowOnError>) => {
 ...
 */
export const findPleskSubscriptionByDomain = <ThrowOnError extends boolean = false>(options: Options<FindPleskSubscriptionByDomainData, ThrowOnError>) => {
