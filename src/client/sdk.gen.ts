...
/**
 * Get Ns Records From Global Dns
 */
export const getNsRecordsFromGlobalDns = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetNsRecordsFromGlobalDnsData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetNsRecordsFromGlobalDnsResponse, GetNsRecordsFromGlobalDnsError, ThrowOnError>({
        ...options,
